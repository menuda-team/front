...
<div class="w-full flex flex-col h-screen items-center justify-center p-4">
	<h1 class="font-medium text-xxl mb-6 text-center">Введите номер телефона</h1>
	<input
		type="tel"
	...
	/>
	<Button type={buttonDisabled ? 'disabled' : 'action'} onClick={onClickButton} classes="w-full block h-[60px]">
		Продолжить
	</Button>
</div>
