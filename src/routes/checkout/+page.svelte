	...
	<section class="w-full mb-6">
		...
		<div class="gap-4 grid w-full">
			...
			<input
				type="text"
				placeholder="Улица"
				bind:value={inputValues.street}
				class="block rounded text-xbase placeholder:text-black3 dark:placeholder:text-dark-gray bg-bg-gray dark:bg-dark-black2 dark:text-white py-4 px-5"
			/>
			<input
				type="text"
				placeholder="Дом"
				bind:value={inputValues.house}
				class="block rounded text-xbase placeholder:text-black3 dark:placeholder:text-dark-gray bg-bg-gray dark:bg-dark-black2 dark:text-white py-4 px-5"
			/>
	...
	<section class="w-full mb-10">
		...
		<div class="gap-4 grid w-full">
			...
			<input
				...
				bind:value={inputValues.phone}
				class="block rounded text-xbase placeholder:text-black3 dark:placeholder:text-dark-gray bg-bg-gray dark:bg-dark-black2 dark:text-white py-4 px-5"
			/>
		</div>
	</section>
	<div class="fixed bottom-0 left-0 right-0">
		<CartButton actionText="Оплатить" totalAmount={$cart.totalAmount} link="" {buttonType} action={makeOrder} />
	</div>
</div>
