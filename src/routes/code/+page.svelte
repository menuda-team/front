...
<div class="w-full flex flex-col h-screen items-center justify-center p-4">
	<h1 class="font-medium text-xxl mb-6 text-center">Введите код из СМС</h1>
	<input
		type="number"
		min="0"
	...
	{/if}
	<Button type={buttonDisabled ? 'disabled' : 'action'} classes="w-full block h-[60px] mt-6">Подтвердить</Button>
</div>
